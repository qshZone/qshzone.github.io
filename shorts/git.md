...
- [Официальный ресурс](http://git-scm.com) с [документацией на русском](https://git-scm.com/book/ru/v2)
...
- [GitExtensions](http://gitextensions.github.io/) - очень популярный GUI
- [TortoiseGit](https://tortoisegit.org/) - визуальная оболочка для управления гитом, особенно удобна для сравнения при операциях merge и rebase

### Полезные статьи

- [Удачная модель ветвления для Git](http://habrahabr.ru/post/106912)
- [Наглядная справка](http://marklodato.github.io/visual-git-guide/index-ru.html)
- [Формирование ключей SSH](https://help.github.com/articles/generating-ssh-keys)
